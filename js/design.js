...
var myPlace = "";
var listStarter = ['build a ikea shelf', 'DJ', 'dress as a bear']

console.log(listStarter.length);

function display(){
  for(var i=0; i < listStarter.length; i++){
    $('#things').append('<li>' + listStarter[i] + '</li>');
  }
}
...
$('#add').click(function(){
    listStarter.push($('#add_place').val());
